...
root = tk.Tk()
root.title('Abhishek Sharma : Calculator')
...
tk.Label(canvas, text='Basic Calculator made by Abhishek', anchor='e', bg='#272533', fg='white', font=('Franklin Gothic Book', 14, 'bold')).grid(row=0, columnspan=4, sticky='ew', padx=4, pady=2)
